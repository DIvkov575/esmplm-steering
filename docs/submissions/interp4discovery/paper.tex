...
against every other target: $+0.30$ overall with intrinsic disorder's
vector, rising to $+0.40$--$0.50$ at the three deepest layers -- consistent
...
compositional heuristics; seed-robustness was checked for two of five
targets; no structural/functional plausibility check was run on generated
sequences.
